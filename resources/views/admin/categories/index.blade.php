                        ...
                        <div class="product-categories-one__inner">
                            <ul>
                                <li><a href="#0" class="img-box">
                                        <div class="inner"><img src="{{asset("assets/images/shop/product-categories-v1-img1.png")}}"
                                                                alt=""></div>
                                    </a>
                                ...
                                <li><a href="#0" class="img-box">
                                        <div class="inner"><img src="{{asset("assets/images/shop/product-categories-v1-img2.png")}}"
                                                                alt=""></div>
                                    </a>
                                    <div class="title"><a href="#0">
                                            <h6>Furnitures</h6>
                                ...
                                <li><a href="#0" class="img-box">
                                        <div class="inner"><img src="{{asset("assets/images/shop/product-categories-v1-img3.png")}}"
                                                                alt=""></div>
                                    </a>
                                    <div class="title"><a href="#0">
                                            <h6>Jewellery</h6>
                                ...
                                <li><a href="#0" class="img-box">
                                        <div class="inner"><img src="{{asset("assets/images/shop/product-categories-v1-img4.png")}}"
                                                                alt=""></div>
                                    </a>
                                    <div class="title"><a href="#0">
                                            <h6>Shoes</h6>
                                ...
                                <li><a href="#0" class="img-box">
                                        <div class="inner"><img src="{{asset("assets/images/shop/product-categories-v1-img5.png")}}"
                                                                alt=""></div>
                                    </a>
                                    <div class="title"><a href="#0">
                                            <h6>Electronics</h6>
                                ...
                                <li><a href="#0" class="img-box">
                                        <div class="inner"><img src="{{asset("assets/images/shop/product-categories-v1-img6.png")}}"
                                                                alt=""></div>
                                    </a>
                                    <div class="title"><a href="#0">
                                            <h6>Fashion</h6>
                                                ...
                                                <div class="col-xl-4 col-lg-6 col-6 ">
                                                    <div class="products-three-single w-100  mt-30">
                                                        <div class="products-three-single-img"><a
                                                                href="{{route("admin.category.show",$product)}}"
                                                                class="d-block"> <img
...
compare</span> </a></li>
                                                        ...
                                                        <div class="products-three-single-content text-center"> <span>Men
                                                            Shoes</span>
                                                            <h5>
                                                                <a href="{{route("admin.category.show",$product)}}"> {{$product->title}} </a>
                                                            </h5>
                                                            <p>
                                                ...
                                                <div class="col-12">
                                                    <div class="product-grid-two list mt-30">
                                                        <div class="product-grid-two__img">
                                                            <a href="{{route("admin.category.show",$product)}}" class="d-block">
